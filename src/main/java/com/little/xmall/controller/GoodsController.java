...
public class GoodsController {
    ...
    @PostMapping("/addManyImages")
    public Response<List<Map<String, Object>>> addManyImages(@RequestBody GoodsImageTestInfo goodsImageTestInfo) {
        return goodsService.addManyImages(goodsImageTestInfo);
    }
}
